...
const DataTabel = () => {
  ...
  return (
    <main className="min-h-screen bg-[#FDFDFD]">
      ...
      <div className="ml-16">
        {/* Welcome Banner */}
        <div className="bg-gray-400 px-8 md:px-16 py-10 mb-10">
          <div className="flex items-center justify-between">
            <div>
              <p className="font-lexend text-white text-sm mb-1">
                Selamat datang kembali
              </p>
              <h1 className="font-lexend text-2xl md:text-3xl font-bold text-white">
                Halo, Admin!
              </h1>
        ...
        <section className="px-6 md:px-16">
          {/* Title */}
          <h2 className="font-lexend text-xl md:text-3xl font-semibold text-[#2C2C2C] mb-3">
            Data Tabel
          </h2>
        </section>
        ...
        <section className="px-6 md:px-16">
          ...
          <div className="mt-4 mb-8">{renderTable()}</div>
        </section>
      </div>
    </main>
  );
